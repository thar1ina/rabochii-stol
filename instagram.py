            ...
            def connectionHandler(self):
                ...
                def run(self):
                    ...
                    def display(self, pwd=None):
                        ...
                        ' +------- Instagram -------+'
                        print
                        ' [-] Username: {}{}{}'.format(creds, self.username.title(), self.n)
                        print
                        ' [-] Password: {}{}{}'.format(creds, pwd, self.n)
                        print
                        ' [-] Proxy IP: {}{}{}'.format(self.b, ip, self.n)
                        print
                        ' [-] Attempts: {}{}{}'.format(self.y, attempts, self.n)
                        print
                        ''
